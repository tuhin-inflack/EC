...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            {!! Form::label('start', trans('labels.start'), ['class' => 'form-label required']) !!} <span class="danger">*</span>
    ...
    <div class="col-md-6">
        <div class="form-group">
            {!! Form::label('end', trans('labels.end'), ['class' => 'form-label required']) !!} <span class="danger">*</span>
            <div class="input-group">
