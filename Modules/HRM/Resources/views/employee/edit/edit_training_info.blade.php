                        ...
                        <div class=" col-md-10">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        {{ Form::label('organization_website', trans('hrm::training.organization_website')) }}
                                        {{ Form::url('organization_website',  $training->organization_website, ['class' => 'form-control', 'placeholder' => 'http://www.bs-23.net', 'data-validation-required-message'=>trans('labels.This field is required')]) }}
                                        <div class="help-block"></div>
                                    </div>
                                </div>
                ...
                <div class="row">
                    ...
                    <div class=" col-md-10">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    {{ Form::label('organization_country',  trans('hrm::training.training_year')) }}
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    {{ Form::label('organization_website', trans('hrm::training.organization_website')) }}
                                    {{ Form::url('organization_website',  null, ['class' => 'form-control', 'placeholder' => 'http://www.bs-23.net', 'data-validation-required-message'=>trans('labels.This field is required')]) }}
                                    <div class="help-block"></div>
                                </div>
                            </div>
