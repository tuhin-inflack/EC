...
@section('title', trans('hrm::employee.employee_loan'))
@push('page-css')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="repeat-form">@lang('hrm::employee.employee_loan')</h4>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            @include('hrm::loan.form.loan-application')
                        </div>
                    </div>
                </div>
            </div>
