        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                <div class="input-group">
                    @if($type == 'checkin')
                        {{ Form::text('start_date', date('j F, Y'), ['id' => 'start_date', 'class' => 'form-control required' . ($errors->has('start_date') ? ' is-invalid' : ''), 'required' => 'required', 'disabled']) }}
                        {{ Form::hidden('start_date', date('j F, Y')) }}
                    @else
                        {{ Form::text('start_date', $page == 'create' ? date('j F, Y') : date('j F, Y', strtotime($roomBooking->start_date)), ['id' => 'start_date', 'class' => 'form-control required' . ($errors->has('start_date') ? ' is-invalid' : ''), 'required' => 'required', $page == 'edit' ? 'data-rule-greaterThanOrEqual="' . date('j F, Y') .'"' : null]) }}
                    @endif
            ...
            <div class="form-group">
                <div class="input-group">
                    {{ Form::text('end_date', $page == 'create' ? (new DateTime())->add(new DateInterval("P1D"))
                                     ->format('j F, Y') : date('j F, Y',strtotime($roomBooking->end_date)), ['id' => 'end_date', 'class' => 'form-control required' . ($errors->has('end_date') ? ' is-invalid' : '')]) }}
                    ...
                    <div data-repeater-item="" style="">
                        <div class="form row">
                            ...
                            <!-- End For Edit Old Room Type -->
                                {!! Form::select('room_type_id', $roomTypes->pluck('name', 'id'), $oldInput['room_type_id'], ['class' => 'form-control required room-type-select' . ($errors->has('roomInfos.' . $loop->index . '.room_type_id') ? ' is-invalid' : ''), 'data-msg-required' => Lang::get('labels.This field is required'),'onChange' => 'getRoomTypeRates(event, this.value)']) !!}
                            ...
                            <div class="form-group mb-1 col-sm-12 col-md-3">
                                ...
                                <br>
                                {!! Form::number('quantity', $oldInput['quantity'], ['class' => 'form-control required' . ($errors->has('roomInfos.' . $loop->index . '.quantity') ? ' is-invalid' : ''), 'data-msg-required' => Lang::get('labels.This field is required'), 'min' => 1]) !!}
                    ...
                    <div data-repeater-item="" style="">
                        <div class="form row">
                            <div class="form-group mb-1 col-sm-12 col-md-4">
                                <label class="required">{{ trans('hm::booking-request.room_type') }}</label>
                                <br>
                                {!! Form::select('room_type_id', $roomTypes->pluck('name', 'id'), null, ['class' => 'form-control room-type-select required', 'data-msg-required' => Lang::get('labels.This field is required'), 'onChange' => 'getRoomTypeRates(event, this.value)']) !!}
                            ...
                            <div class="form-group mb-1 col-sm-12 col-md-3">
                                ...
                                <br>
                                {!! Form::number('quantity', null, ['class' => 'form-control required', 'data-msg-required' => Lang::get('labels.This field is required'), 'min' => 1]) !!}
                            </div>
                            <div class="form-group mb-1 col-sm-12 col-md-3">
                                <label class="required">{{ trans('hm::booking-request.rate') }}</label>
                                <br>
                        ...
                        <div data-repeater-item="" style="">
                            <div class="form row">
                                <div class="form-group mb-1 col-sm-12 col-md-4">
                                    ...
                                    {!! Form::select('room_type_id', $roomTypes->pluck('name', 'id'), $roomInfo->room_type_id, ['class' => 'form-control room-type-select required', 'data-msg-required' => Lang::get('labels.This field is required'), 'onChange' => 'getRoomTypeRates(event, this.value)']) !!}
                                    <span class="select-error"></span>
                                </div>
                                <div class="form-group mb-1 col-sm-12 col-md-3">
                                    <label class="required"
                                           for="quantity">{{ trans('hm::booking-request.quantity') }}</label>
                                    <br>
                                    {!! Form::number('quantity', $roomInfo->quantity, ['class' => 'form-control required', 'data-msg-required' => Lang::get('labels.This field is required'), 'min' => 1]) !!}
                                </div>
                                <div class="form-group mb-1 col-sm-12 col-md-3">
                                    <label class="required">{{ trans('hm::booking-request.rate') }}</label>
                                    <br>
