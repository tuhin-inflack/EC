                            ...
                            <div data-repeater-item="" style="">
                                <div class="form row">
                                    <div class="form-group  mb-1 col-sm-12 col-md-5 {{ $errors->hostelBudget->has("hostel_budgets.".$key.".hostel_budget_section_id") ? 'error' : '' }}">
                                        ...
                                        {{ Form::select('hostel_budget_section_id', $budgetSections, $budget['hostel_budget_section_id'], ['placeholder' =>'Select budget section',   'class' => ' form-control ', 'required' => 'required', 'data-validation-required-message'=>'Please select budget section ']) }}
                                        <div class="help-block"></div>
                                    ...
                                    {{ Form::label('budget_amount', 'Amount *') }}
                                        {{ Form::number('budget_amount', $budget['budget_amount'], ['class' => 'form-control', 'placeholder' => '','required' => 'required', 'data-validation-required-message'=>'Please enter budget amount']) }}
                                        <div class="help-block"></div>
