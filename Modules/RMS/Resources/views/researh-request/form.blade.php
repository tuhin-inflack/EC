...
<div class="col-md-8 offset-2">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title" id="basic-layout-form">Create Request Research Proposal</h4>
            ...
            <div class="card-content collapse show">
                <div class="card-body">
                    {!! Form::open() !!}
                    <div class="form-body">
                        <h4 class="form-section"><i class="la la-briefcase"></i> Research Proposal Request Form</h4>
                        <div class="row">
                            <div class="col-md-12">
