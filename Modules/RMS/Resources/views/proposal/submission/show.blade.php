                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{route('organization.add-research-organization', $research->id)}}" class="btn btn-primary btn-sm pull-right"><i class="ft-plus"></i>@lang('pms::project_proposal.add_organization')</a>
