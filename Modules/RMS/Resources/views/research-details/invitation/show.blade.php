                                ...
                                <dd class="col-sm-9">
                                    <ul>
                                        @foreach($researchDetailInvitation->researchDetailInvitationAttachments as $file)
                                            <li><a href="{{ route('research-proposal-details.invitation.file-download', ['attachment' => $file->id]) }}">{{ $file->file_name }}</a></li>
                                        @endforeach
                                    </ul>
                                    <ul>
                                        <li><b><a href="{{ route('research-proposal-details.invitation.attachment-download', ['researchDetailInvitation' => $researchDetailInvitation->id]) }}">@lang('pms::project_proposal.download_all_attachments')</a></b></li>
                                    </ul>
                                </dd>
                            </dl>
                            <dl class="row">
