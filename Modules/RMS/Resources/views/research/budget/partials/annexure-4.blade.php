                            ...
                            <table class="table table-bordered table-responsive">
                                ...
                                @foreach($research->budgets as $budget)
                                    @if($budget->section_type === 'revenue')
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{ route('research-budget.edit', [$research->id, $budget->id]) }}"><i class="la la-edit"></i></a>{{ $budget->economyCode->code }}</td>
                                ...
                                @foreach($research->budgets as $budget)
                                    @if($budget->section_type === 'physical_contingency')
                                        ...
                                        <tr>
                                            <td colspan="2"><a href="{{ route('research-budget.edit', [$research->id, $budget->id]) }}"><i class="la la-edit"></i></a></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
