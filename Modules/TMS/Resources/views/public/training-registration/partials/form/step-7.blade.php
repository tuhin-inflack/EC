...
<fieldset>
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-6">
                    <label for="shortDescription1" class="required">@lang('tms::training.hieght') : (@lang('tms::training.inch'))</label>
                ...
                <div class="col-md-6">
                    <label for="shortDescription1" class="required">@lang('tms::training.weight') : (@lang('tms::training.kilogram'))</label>
            ...
            <div class="row">
                <div class="col-md-4">
                    <label for="shortDescription1" class="required">@lang('tms::training.normal_chest') : (@lang('tms::training.inch'))</label>
                ...
                <div class="col-md-4">
                    <label for="shortDescription1" class="required">@lang('tms::training.expended_chest') : (@lang('tms::training.inch'))</label>
                ...
                <div class="col-md-4">
                    <label for="shortDescription1" class="required">@lang('tms::training.weight_end_course') : (@lang('tms::training.kilogram'))</label>
