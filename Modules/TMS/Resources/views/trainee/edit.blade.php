            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            {!! Form::open(['url' =>  route('trainee.update',['trainee_id' => $traineeId]), 'class' => 'form', 'novalidate', 'method' => 'post']) !!}
                            <div class="form-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="training_id" value="{{$trainee->training->training_id}}" required>
                                            <input id="training_id" type="text"
                                                   class="form-control {{ $errors->has('training_id') ? ' is-invalid' : '' }}"
                                                   name="training_id" value="{{$trainee->training->training_id}}" readonly required data-validation-required-message="{{trans('validation.required', ['attribute' => trans('tms::training.training_id')])}}" autofocus>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="training_name" type="text" class="form-control {{ $errors->has('training_title') ? ' is-invalid' : '' }}" name="training_title" value="{{$trainee->training->training_title }}" required readonly data-validation-required-message="{{trans('validation.required', ['attribute' => trans('tms::training.training_name')])}}">
                                            <div class="help-block"></div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <label class="radio-inline"><input type="radio" name="trainee_gender" required data-validation-required-message="{{trans('validation.required', ['attribute' => trans('tms::training.trainee_gender')])}}" value="Male" {{(ucwords($trainee->trainee_gender) == 'Male')? 'checked':''}}> {{__('labels.male')}}</label>
                                                <label class="radio-inline"><input type="radio" name="trainee_gender" required data-validation-required-message="{{trans('validation.required', ['attribute' => trans('tms::training.trainee_gender')])}}" value="Female" {{(ucwords($trainee->trainee_gender) == 'Female')? 'checked':''}}> {{__('labels.female')}}</label>
                            ...
                            <div class="form-actions">
                                ...
                                <button class="btn btn-warning" type="button" onclick="window.location.href= '{{route('trainee.index', $trainee->training->id)}}'">
