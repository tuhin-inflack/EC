        ...
        @auth
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="{{ is_active_route('pms')}} nav-item">
                    <a href="{{ url('pms') }}"><i class="la la-home"></i><span class="menu-title" data-i18n="nav.dash.main">@lang('labels.dashboard')</span></a>
                </li>
                <li class="{{ is_active_route('project.index') }} nav-item">
                    <a href="{{ route('project.index') }}"><i class="la la-briefcase"></i><span class="menu-title" data-i18n="nav.dash.main">@lang('pms::project_proposal.projects')</span></a>
                </li>
