                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                               value="{{ old('send_to') ?: $projectRequest->send_to }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type='text' value="{{ old('end_date') ?: $projectRequest->end_date }}"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="message"
                                                  ...
                                                  id="" cols="30" rows="10"
                                                  required>{{ old('message') ?: $projectRequest->message }}</textarea>
