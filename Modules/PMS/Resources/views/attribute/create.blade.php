                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {!! Form::select('organization_id', ['1' => 'BS-23', '2' => 'Inflack'], null, ['class' => 'form-control select2' . ($errors->has('organization_id') ? ' is-invalid' : ''), 'placeholder' => trans('labels.select'), 'required']) !!}
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {!! Form::text('unit', null, ['class' => 'form-control' . ($errors->has('unit') ? ' is-invalid' : ''), 'required']) !!}
