            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-10"><h4 class="card-title">{{trans('labels.notification')}}</h4></div>
                            <div class="col-md-2 text-right"><a href="{{route('notification.clear')}}">{{trans('labels.clear_all')}}</a>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    $('body').removeClass('vertical-menu 2-columns menu-expanded');
</script>
@endpush
